    ...
    return (
        <>
            <div className="bg-primary text-white">
                <div className="flex justify-between items-center py-4 max-w-screen-2xl mx-auto  text-gray-400">
                    ...
                    <div className="flex gap-4 font-semibold text-white items-center">
                        ...
                        <Image width={35} height={35} src="/icons/fb.png" alt="" className="hover:cursor-pointer" />
                        <Image width={35} height={35} src="/icons/ig.png" alt="" className="hover:cursor-pointer" />
                    </div>
                </div>
            </div>
