        ...
        <div className='max-w-screen-xl mx-auto'>
            ...
            <div className='flex justify-center gap-8 min-w-full mb-8'>
                <div className='bg-blue-50 p-8 rounded-md w-1/3'>
                    <h3 className='font-semibold text-xl'>Login Customers</h3>
                    <p className='text-sm my-4'>If you have an account, sign in with your email address.</p>
                    <form action="">
                        ...
                        <div className='flex gap-8 my-4 items-center'>
                            <button className='px-8 py-2 border-2 font-semibold rounded-full text-white bg-blue-600 border-blue-600 hover:bg-white hover:text-blue-600 transition' type="submit">Login</button>
                            <Link href="/forgot-password" className='text-sm font-semibold text-blue-500 hover:underline'>
